...
class Game:
    def __init__(self):
        ...
        Blob.images = [load_image("slime1.bmp"), load_image("slime2.bmp"), load_image("slime3.bmp"),
                       load_image("slime4.bmp"), load_image("slime5.bmp"), load_image("slime6.bmp"),
                       load_image("slime7.bmp"), load_image("slime8.bmp")]
